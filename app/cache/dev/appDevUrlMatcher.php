...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'Main_home');
            }

            return array (  '_controller' => 'Welinkeo\\MainBundle\\Controller\\PublicController::indexAction',  '_route' => 'Main_home',);
        }

        // Main_alimentaire
        if ($pathinfo === '/alimentaire') {
            return array (  '_controller' => 'Welinkeo\\MainBundle\\Controller\\PublicController::alimentaireIndexAction',  '_route' => 'Main_alimentaire',);
        }
